...
"""
from utils import get_all_data_loaders, prepare_sub_folder, write_html, write_loss, get_config, write_2images, Timer, get_data
import argparse
...
parser.add_argument('--config', type=str, default='configs/mri_degad.yaml', help='Path to the config file.')
